...
object DataSimple {
    ...
    val textCondition = "Terms and Conditions of Use\n" +
            ...
            "\t•\tProviding health and HIV-related information and education for prevention,\n" +
            "\t•\tPrimarily recruiting individual at risk for HIV, STIs, and/ or TB, and referring them to get Voluntary Confidential Counselling and Testing (VCCT) and/ or treatment,\n" +
            "\t•\tRetaining people living with HIV in care and treatment, and people having HIV, STIs, and/ or TB related risk behaviours in prevention. \n" +
            ...
            "\t•\tAccess to news and information about HIV/ AIDS, STIs, TB, sexual health and other related issues for prevention, treatment, or care and support,\n" +
            "\t•\tTest their knowledge on how much they know about HIV/ AIDS, STIs, TB, and sexual health as well as determine their HIV risk through simple questions of the HIV Risk Meter,\n" +
            "\t•\tSearch for nearby health and HIV-related service availability to get testing, counselling, and/ or treatment,\n" +
            "\t•\tSet up their own personal reminders for testing appointment, medication, and prescription refill, and it is able to be connected with Apple Watch in order to make more channel for reminders, \n" +
            "\t•\tRecord number of CD4 and Viral Load for users with HIV positive, so they can track the progress on their health during the treatment,\n" +
            "\t•\tSecure access to their privacies on the Service with Passcode Lock and Touch ID,\n" +
            "\t•\tRate the Service, and provide feedback for improvement,\n" +
            "\t•\tExperience other features and functions as provided on the Services.\n" +
            ...
            "\t•\tAll Users shall use the Service in accordance with the terms stated in the Terms and Conditions. Users may not use the Service unless they agree to the Terms and Conditions. Such agreement is valid, enforceable, and irrevocable,\n" +
            "\t•\tBy actually using the Service, Users are deemed to have agreed to the Terms and Conditions. Such agreement is valid, enforceable, and irrevocable,\n" +
            "\t•\tIf there is any changes or modifications made to the Terms and Conditions for the Service, Users also shall comply with such changes or modifications as well as the Terms and Conditions.\n" +
            "\n" +
            ...
            "\n" +
            "\t•\tUser Account\n" +
            "\t•\tTo access and use the Service, Users must register for a LoveApp account (hereinafter referred to as the \"Account\") by providing accurate, complete, and up-to-date information indicated as required. Users are responsible to promptly update such information if it changes,\n" +
            "\t•\tTo protect the Account, Users shall create login credentials by using a strong password and limiting its use to this Account. Users are responsible for keeping their password secure. Raks Thai Foundation cannot and will not be liable for any loss or damage from any failures to maintain the security of Users’ Account and password,\n" +
            "\t•\tUsers are entirely responsible for any and all usages or activities that occur under the Account,\n" +
            ...
            "\t•\tUsers acknowledge that Raks Thai Foundation might use the email address users provided as the primary method for communication,\n" +
            "\t•\tRaks Thai Foundation, in its sole discretion, may suspend or delete a User's Account without giving prior notice to User if we find that User is violating or has violated the Terms and Conditions.\n" +
            "\n" +
            "\t•\tPrivacy \n" +
            ...
            "\n" +
            "\t•\tContent on the Service and Third Party Link\n" +
            ...
            "\t•\tRaks Thai Foundation shall not be responsible for any damages inflicted upon Users in relation to the use of the Service. \n" +
            "\t•\tRaks Thai Foundation shall not be responsible for any indirect, special, incidental, consequential or punitive damages (including but not limited to such damages that Raks Thai Foundation or Users predicted or could have predicted) with respect to our contractual default or act of tort due to our negligence (except for gross negligence).\n" +
            "\n" +
            "\t•\tGoverning Law\n" +
            ...
            "\n" +
            "\t•\tContact Information\n" +
            "Should Users have any questions or concerns with respect to these Terms and Conditions of Use or the Service, Users can directly contact us via email at the following address:"
